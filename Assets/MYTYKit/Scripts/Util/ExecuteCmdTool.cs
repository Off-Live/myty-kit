...
namespace MYTYKit
{
    ...
    {
        private string layerToolPath =
            "Assets/MYTYKit/CmdTools/LayerTool/.extracted/macOS/export_layer_effect_x86/export_layer_effect_x86";
        ...
        public void ExecuteLayerTool(string psbPath, GameObject rootNode)
        {
            ...
            if (effects == null)
                effects = AssetDatabase.LoadAssetAtPath<LayerEffectList>(
                    "Assets/MYTYKit/LayerEffect/LayerEffectList.asset");
            ...
            if (SystemInfo.operatingSystem.StartsWith("Mac"))
            {
                ...
                {
                    layerToolPath =
                        "Assets/MYTYKit/CmdTools/LayerTool/.extracted/macOS/export_layer_effect/export_layer_effect";
                }
